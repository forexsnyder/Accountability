  ...
  return (
    <div className="App">
      <div className="goals-box">
        ...
        <h2>Monthly Goal:{mgoal1} </h2><button onClick={(e)=>handleClick5(upDateMg1(!mg1))}>Completed</button>
        <h2>Weekly Goal:{wgoal1}</h2><button onClick={(e)=>handleClick4(upDateWg1(!wg1))}>Completed</button>
        <h3>Daily Goals:</h3>
        <h1>{dgoal1}</h1><button onClick={(e)=>handleClick(upDateDg1(!dg1))}>Test Completed</button>
        <h1>{dgoal2}</h1><button onClick={(e)=>handleClick2(upDateDg2(!dg2))}>Completed</button>
        <h1>{dgoal3}</h1><button onClick={(e)=>handleClick3(upDateDg3(!dg3))}>Completed</button>
